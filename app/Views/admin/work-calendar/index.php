...
<section class="dashboard-panel mb-4" aria-labelledby="calendar-generate-title">
    ...
    <div class="calendar-information"><i class="bi bi-info-circle" aria-hidden="true"></i><p>Kalender kerja adalah snapshot jadwal employee untuk menentukan hari kerja, hari libur, dan Alpha pada laporan. Snapshot tanggal lampau yang sudah tersedia tidak akan ditimpa.</p></div>
