...
ob_start();
?>
<section class="management-heading mb-4"><div><p class="dashboard-eyebrow mb-1">Master Data</p><h1 class="dashboard-title">Tambah Jadwal Kerja</h1><p class="dashboard-date mb-0">Atur waktu kerja dan toleransi keterlambatan.</p></div></section>
